...
function rowToSettings(r: any): Settings {
  return {
    ...
    taxMileageRateCents: r.tax_mileage_rate_cents == null ? undefined : Number(r.tax_mileage_rate_cents),
...
function rowToExpense(r: any) {
  return {
    ...
    receiptMimeType: r.receipt_mime_type ?? undefined,
    receiptSizeBytes: r.receipt_size_bytes ?? undefined,
    notes: r.notes ?? undefined,
    createdAt: r.created_at,
    updatedAt: r.updated_at,
  }
...
function rowToReqAct(r: any) {
  return {
    ...
    evidenceStoragePath: r.evidence_storage_path ?? undefined,
    evidenceFileName: r.evidence_file_name ?? undefined,
    evidenceMimeType: r.evidence_mime_type ?? undefined,
    evidenceSizeBytes: r.evidence_size_bytes ?? undefined,
    notes: r.notes ?? undefined,
    createdAt: r.created_at,
    updatedAt: r.updated_at,
  }
...
function settingsToRow(s: Settings, userId: string) {
  return {
    ...
    tax_mileage_rate_cents: s.taxMileageRateCents ?? null,
  ...
  switch (k) {
    ...
    case 'expenses':
      return items.map((e: any) => ({
        ...
        miles: e.miles ?? null,
        receipt_storage_path: e.receiptStoragePath || null,
        receipt_file_name: e.receiptFileName || null,
        receipt_mime_type: e.receiptMimeType || null,
        receipt_size_bytes: e.receiptSizeBytes ?? null,
        notes: e.notes || null,
        created_at: e.createdAt || nowISO(),
        updated_at: e.updatedAt || nowISO(),
      }))
    ...
    case 'requirementActivities':
      return items.map((a: any) => ({
        ...
        evidence_storage_path: a.evidenceStoragePath || null,
        evidence_file_name: a.evidenceFileName || null,
        evidence_mime_type: a.evidenceMimeType || null,
        evidence_size_bytes: a.evidenceSizeBytes ?? null,
        notes: a.notes || null,
